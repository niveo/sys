...
public record EmpresaDto(Long codigo, String documento, String nome, String razaoSocial, String observacao,
	...
	public Empresa toEmpresa(Empresa empresa, Cidade cidade, Bairro bairro) {
		return empresa.toBuilder().codigo(codigo).tipoPessoa(tipoPessoa).documento(documento).nome(nome.toUpperCase())
				.inscricaoEstadual(inscricaoEstadual).razaoSocial(razaoSocial.toUpperCase()).observacao(observacao)
