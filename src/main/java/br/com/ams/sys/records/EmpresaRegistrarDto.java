...
public record EmpresaRegistrarDto(Long codigo, String documento, String nome, String razaoSocial, String observacao,
		String telefone, String email, String inscricaoEstadual, TipoPessoa tipoPessoa,
		EmpresaRegistrarEnderecoDto endereco) {
